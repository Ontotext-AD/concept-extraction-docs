...
<li>Add the coordinator-specific parameters to the Tomcat setup. Use the `/bin/setenv.sh` file. For example:</li>
...
<li>Add the worker-specific parameters to the Tomcat setup. Use the `/bin/setenv.sh` file. For example:</li>
